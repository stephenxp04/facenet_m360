...
class SampleAssistant(object):
    ...
    def is_grpc_error_unavailable(self, e):
    ...
    def gen_voice_assist_requests(self):
        """Yields: AssistRequest messages to send to the API in audio form"""
        ...
        while True:
            if assistant.MODE is 0 or assistant.MODE is 1:
                ...
                while True:
                        ...
                        if name is not '':
                            ...
                            if name not in cached_list:
                                ...
                                cached.update({'ref': DateTimeStamp}, {'$push': {'cached': name}})
                                query = name + "first"
                ...
                if assistant.MODE is 0:
                    ...
                    text, continue_conversation = assistant.assist(text_query=query)
                    #print(text)
